...
class AddQestScreen extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownRow(
                      txt: 'اختر المنتج',
                      dSize: MediaQuery.of(context).size,
                      category: widgetProvider.productName,
                  ...
                  DropdownRow(
                      txt: 'اختر اللون',
                      dSize: MediaQuery.of(context).size,
                      category: dbProvider.color,
                      categories: List.generate(dbProvider.colors.length,
